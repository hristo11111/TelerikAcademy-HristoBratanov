<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="_02.ValidateGroups.Register" %>
...
<body>
    ...
    <asp:Label ID="LabelUserName" 
        ...
        <asp:RequiredFieldValidator 
            ...
            ValidationGroup="ValidationGroupLogon" 
            ErrorMessage="Username required!" Display="Static"/>
        <br />
        ...
        <asp:RequiredFieldValidator 
            ...
            ValidationGroup="ValidationGroupLogon"
            ErrorMessage="Password required!" Display="Static"/>
        <br />
        ...
        <asp:RequiredFieldValidator 
            ...
            ValidationGroup="ValidationGroupLogon"
            ErrorMessage="Repeat password is required!" Display="Static"/>
        ...
        <br />
        <asp:Button ID="Button_ValidateLogon" runat="server" Text="Validate Logon" OnClick="Button_ValidateLogon_Click" />
        <asp:Label ID="LabelLogon" runat="server" />
        <br />
