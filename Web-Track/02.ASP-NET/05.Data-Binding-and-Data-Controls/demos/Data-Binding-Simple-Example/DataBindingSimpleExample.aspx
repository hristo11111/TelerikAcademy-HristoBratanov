...
<body>
    <form id="formMain" runat="server">
        ...
        <asp:DropDownList ID="DropDownCars" runat="server" AutoPostBack="true"
            onselectedindexchanged="DropDownCars_SelectedIndexChanged">
        </asp:DropDownList>
        <asp:Label ID="LabelCars" runat="server"></asp:Label>
    </form>
</body>
