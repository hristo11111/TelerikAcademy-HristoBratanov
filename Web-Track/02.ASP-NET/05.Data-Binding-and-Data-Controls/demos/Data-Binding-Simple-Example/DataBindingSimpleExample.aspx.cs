    ...
    public partial class DataBindingSimpleExample : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                var cars = new string[] { "bmw", "mercedes", "audi", "toyota" };
                this.DropDownCars.DataSource = cars;
                this.DropDownCars.DataBind();
            }
        }
        ...
        {
            this.LabelCars.Text = this.DropDownCars.SelectedValue;
        }
    }
}
