<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="EventsSystem.Account.Manage" %>
        ...
        <div class="span6">
            ...
            <section id="externalLoginsForm">
                    <fieldset>
                        ...
                        <div class="form-actions no-color">
                            <asp:Button runat="server" Text="Upload" OnClick="UploadImage_Click" CssClass="btn" />
                        </div>
                    </fieldset>
            </section>
