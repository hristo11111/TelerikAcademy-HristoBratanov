...
namespace NorthwindTwin.Model
{
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<ProductsUnderThisUnitPrice_Result> ProductsUnderThisUnitPrice(Nullable<decimal> price)
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(ProductsUnderThisUnitPrice_Result).Assembly);
    
            var priceParameter = price.HasValue ?
                new ObjectParameter("price", price) :
                new ObjectParameter("price", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProductsUnderThisUnitPrice_Result>("ProductsUnderThisUnitPrice", priceParameter);
        }
    
        public virtual ObjectResult<Customers_By_City_Result> Customers_By_City(string param1)
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(Customers_By_City_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(CustOrdersDetail_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(CustOrdersOrders_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(Employee_Sales_by_Country_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(Get_Customer_And_Orders_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(Sales_by_Year_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(SalesByCategory_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(Ten_Most_Expensive_Products_Result).Assembly);
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(Whole_Or_Partial_Customers_Set_Result).Assembly);
